...
実印は家から出ないので、**銀行が泥棒に入られても盗まれるのは印影だけ**。印影から実印は作れない。書類は毎回新しいので、昨日の押印書類を拾った人が窓口に出しても無効。しかも書類には銀行名(RP ID = このアプリのドメイン)が刷り込まれていて、偽銀行の書類には金庫が押印を拒否する。これがフィッシング耐性の正体。
